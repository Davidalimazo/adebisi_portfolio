            ...
            mywork.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <Box sx={{ alignItems: "center", justifyContent: "right" }}>
                    <span
                      style={{
                        float: "right",
                        marginRight: "2rem",
                  ...
                  <Box variant="contained" sx={{ ml: "2rem", mr: "2rem" }}>
                    <a
                      style={{
                        ...
                        background: !active
                          ? "rgba(45, 36, 81, 0.6)"
                          : "linear-gradient(283.57deg, #7A66E1 6.6%, #8881D7 69.5%, rgba(102, 173, 204, 0.9) 116.55%)",
                        padding: "10px",
                        color: !active ? "#6F6D93" : "#F7F7F8",
                        fontSize: "14px",
                        fontWeight: 500,
                        lineHeight: "18.23px",
                        fontFamily: "DM Sans",
